...
<section class="section section--feature"><div class="container"><div class="section-head"><div><div class="eyebrow">{c['nav']['services']}</div><h2>{h['services_title']}</h2></div><p class="section-intro">{h['services_intro']}</p></div><div class="services-grid">{svc}</div></div></section>
